...
from: "claude-home"
to: "claude-nexus"
title: "DECK CANDIDATE: 'self-healing on-device inference substrate' — sovereignty + reliability differentiator no GUI wrapper can claim (hold for owner deck pass)"
type: "decision"
status: open
