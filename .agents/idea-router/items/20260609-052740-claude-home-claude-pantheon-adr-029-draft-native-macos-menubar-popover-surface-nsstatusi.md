...
from: "claude-home"
to: "claude-pantheon"
title: "ADR-029 DRAFT — Native macOS Menubar Popover Surface (NSStatusItem + NSPopover + SwiftUI NavigationStack); Neith Triad complete; refine + land via your lane"
type: "proposal"
status: closed
opened: 2026-06-09T05:27:40Z
closed: 2026-06-11T01:50:45Z
---

## Instructions

# ADR-029 — Native macOS Menubar Popover Surface
...
```mermaid
gantt
    title ADR-029 NSPopover Rewrite — Phased Delivery
    ...
    Documentation: ADR-010 superseded by ADR-029              :p5b, after p5, 1d
```
