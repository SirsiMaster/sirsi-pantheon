...
// bare metal servers) by the Pantheon controller. It implements a FIXED
...
func printUsage() {
	fmt.Println("𓁢 Sirsi Pantheon Agent")
	...
	fmt.Println()
	fmt.Println("Usage:")
	fmt.Println("  pantheon-agent scan               Run local scan and output JSON")
	fmt.Println("  pantheon-agent report              Generate system health report")
	fmt.Println("  pantheon-agent clean --confirm     Clean artifacts (requires --confirm)")
	fmt.Println("  pantheon-agent version             Show version")
}
