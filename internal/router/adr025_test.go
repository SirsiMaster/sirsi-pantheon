...
// TestReconcileExits_SuccessorCarriesConsumerCapable verifies that a successor
// minted by ReconcileExits carries ConsumerCapable from the reaped predecessor.
// This is the regression guard for the bug claude-home identified in PR #596
// review: for lanes that earned consumer credit explicitly (non-claude/codex
// surfaces), dropping the field on mint caused WakePass to still skip the lane,
// reproducing the false lane-needs-you loop for exactly that subset.
