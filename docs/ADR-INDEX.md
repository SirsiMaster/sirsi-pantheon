...
**Registry audit (2026-08-06): 55 base documents + ADR-031-A/B/C; 4 legacy collisions (013, 016, 046, 054); ADR-056 unresolved.** Numbers are allocated only by `sirsi adr claim`; this index does not declare a “next available” number.
