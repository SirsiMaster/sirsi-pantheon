...
| [ADR-067](ADR-067-MAILOPS.md) | Mail Ops — poison-message detection (empty text/plain part that hangs Outlook's IMAP sync) and archive-only cleanup, Ma'at-gated, dry-run default, signed receipts; Anubis hygiene domain extended to cover mailboxes; Outlook log watcher + token-expiry decision deferred to the owner | **Accepted** | 2026-09-25 |
