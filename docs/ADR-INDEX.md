...
**Total ADRs: 54 (+ ADR-031-A/B/C sub-decisions)** | **Next available: ADR-055**
...
| ADR-054 | **Proposed (owner-gated)** — SNE Licensing, Anubis/Ra Product Seam, and Disclosure Posture. SNE permanently closed; Anubis open/free, Ra commercial; `--profile interactive\|fleet` is the license seam; A33 governs all outward claims; cross-repo binding of sirsi-inference ADR-002. Content requires owner blessing before merge. |
| ADR-055 | Next available |
