...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| `claude-home`     | router-hardening + signed-release + cross-repo binds (ORCHESTRATE-don't-absorb; PR#89 merge + release re-run + nexus/FW wakes pending)                                                                                                          | 2026-06-20 | `/Users/thekryptodragon/Development/sirsi-pantheon/docs/continuations/claude-home-router-hardening-release-sweep-20260620-dbcc9ed5.md` |
