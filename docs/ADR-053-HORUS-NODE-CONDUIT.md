...
This ADR was originally submitted as ADR-051 in the same batch as PR #449 (which also
claimed ADR-051 and was merged first). It was renumbered to ADR-052 in PR #461, but
ADR-052 was concurrently claimed and merged by PR #459 (A2A/Router-Conduit Operating
Rules). Final canonical number is **ADR-053**.
...
- ADR-051: Anubis/Ra SNE Supervisor Split (companion ADR; Anubis profile selection)
- ADR-052: A2A/Router-Conduit Operating Rules (companion ADR; conduit operating contract)
