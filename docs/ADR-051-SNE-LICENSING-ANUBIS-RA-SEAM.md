# ADR-051 — SNE Licensing, Anubis/Ra Product Seam, and Disclosure Posture
...
- **Distribution**: open Anubis is the free distribution channel — gets the
  ...
  on top.
- **ADR-INDEX updated**: ADR-051 added; next available becomes ADR-051.
...
Changelog: v0.9.1 — ADR-051 SNE licensing and Anubis/Ra seam canon landed
