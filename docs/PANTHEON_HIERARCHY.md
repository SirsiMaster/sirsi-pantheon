...
## 𓀭 III. The Code Gods (Governance & Knowledge)
*The cluster of decision-making, standards, memory, and healing.*
...
2. **Machine Gods** execute the Plan.
3. **Ma'at** weighs the Execution.
