...
[ "$tables" = 16 ]        || { echo "FAIL: expected 16 tables (15 + schema_version), got $tables"; exit 1; }
...
[ "$version" = 21 ]       || { echo "FAIL: schema_version should pair with SQLite v21, got $version"; exit 1; }
